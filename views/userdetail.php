					...
					<div class="row">
						<div class="col-xs-12 col-sm-3 center">
							<span class="profile-picture">
								<img class="editable img-responsive" alt=" Avatar" id="avatar2" src="<?php echo currentUser()['user_photo'];?>">
							</span>
							<div class="space space-4"></div>


							<a href="/edituser" class="btn btn-sm btn-block btn-primary">
							
								<span class="bigger-110">Edit Profile</span>
							</a>
                            <a href="/viewblogs" class="btn btn-sm btn-block btn-primary">
							
                            <span class="bigger-110">View Blogs</span>
                        </a>
						</div><!-- /.col -->
						...
						<div class="col-xs-12 col-sm-9">
							...
							<div class="profile-user-info">
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
					                     <span><?php echo  currentUser()['lastname'];?></span>
									</div>
								</div>
                                ...
                                <div class="profile-info-row">
									...
									<div class="profile-info-value">
										...
										<span><?php echo  currentUser()['city'];?></span>
									</div>
								</div>
                                <div class="profile-info-row">
									...
									<div class="profile-info-value">
										<i class="fa fa-map-marker light-orange bigger-110"></i>
										<span><?php echo  currentUser()['address'];?></span>
									</div>
								</div>
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span><?php echo  currentUser()['reg_date'];?></span>
									</div>
								</div>
